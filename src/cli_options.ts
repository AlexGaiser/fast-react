...
import { scssExecutable, jestExecutable, paramExecutable} from './cli_functions';
...
const cliOptions: { [key:string]: object} = {
  scss: {type: "boolean", alias: "Include SCSS?", default: false},
  jest: {type: "boolean", alias: "Include Jest?", default: false},
  param: {type: "string", alias: "Test arg takes param", demandOption: true},
  env: {choices: environments, demandOptions: true, describe:"Environment Type"}
};

// matches cliOptions items with code to be executed should they be passed
const cliExecutables: { [key:string]: Function} = {
  scss: scssExecutable,
  jest: jestExecutable,
...
const handleArguments: Function = (yargsV: object) => {
